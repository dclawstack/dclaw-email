...
**DClaw Mail** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8022` (FastAPI)
- **Frontend Port:** `3022` (Next.js)
- **Database:** `dclaw_email` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3022`
